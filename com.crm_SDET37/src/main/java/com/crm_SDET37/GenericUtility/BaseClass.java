...
public class BaseClass 
{
	...
	com.crm.RmgYantra.Pages.LoginPage homepage = new com.crm.RmgYantra.Pages.LoginPage(driver);
		//LoginPage lpage=new LoginPage(driver);
		homepage.loginToRmgYantraPage(USERNAME, PASSWORD);
	...
	{
		com.crm.RmgYantra.Pages.HomePage homePage=new com.crm.RmgYantra.Pages.HomePage(driver);
